...
export default function TarotCurriculumScreen() {
  ...
  return (
    <SacredBackground>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Tarot ve Arkana</Text>
        <View style={{ width: 28 }} />
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {activeTab === 'cirak' && (
          <BlurView intensity={30} tint="dark" style={styles.introCard}>
            <Ionicons name="albums-outline" size={40} color={COLORS.primary} style={{ marginBottom: 15 }} />
